...
/// Some constants for light/dark iOS + Android based on the generated theme
final cupertinoDarkTheme = MaterialBasedCupertinoThemeData(
  materialTheme: const MainTheme(
    Typography.whiteCupertino,
  ).theme(MainTheme.darkScheme()),
);

final cupertinoLightTheme = MaterialBasedCupertinoThemeData(
  materialTheme: const MainTheme(
    Typography.blackCupertino,
  ).theme(MainTheme.lightScheme()),
);

final ThemeData materialDarkTheme = const MainTheme(
  Typography.whiteMountainView,
).theme(MainTheme.darkScheme());

final ThemeData materialLightTheme = const MainTheme(
